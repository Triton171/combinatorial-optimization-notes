...
\begin{proof}
	...
	Let $v_{i_1},\ldots,v_{i_{2k+1}}$ be the ''first'' odd circuit.
	Then $r(\pi)$ is attained by $2k$ swaps: For $j=1,\ldots,k$ swap
...
\begin{figure}
	...
	\end{graph}
	\captionof{figure}{Counter example for the reverse porposition.}
\end{figure}
