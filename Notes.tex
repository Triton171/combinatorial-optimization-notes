...
\begin{theorem}[Edmonds (1967)]
	...
	\[P_{ST}\coloneqq \set{x\in [0,1]^{E(G)}\ |\ x(E(G))=n-1,\forall \emptyset\subsetneq X\subseteq V(G): \sum_{e\in E(G[X])}x_e\leq \abs{X}-1}\]
...
\begin{proof}
	...
	\begin{align*}
		...
		&\max\set{1^ty\ |\ y\in\bR^{r\text{-cuts}}yA\leq c,\ y\geq0}
	\end{align*}
	\begin{claim}
		The system is TDI.
	\end{claim}
